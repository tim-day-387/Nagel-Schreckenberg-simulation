...
class Representation():
    ...
    # Draw the general outline of the road
    ...
    # Draw each individual cell on the road
    ...
    # Draw each car in its proper location
    ...
    # Get position on screen, accounting for offsets
